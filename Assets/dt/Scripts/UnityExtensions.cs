...
namespace DTerrain
{
    public static class UnityExtensions
    {
        ...
        public static bool Overlaps(RectInt current, RectInt other)
        {
            return other.xMin < current.xMax
                && other.xMax > current.xMin
                && other.yMin < current.yMax
                && other.yMax > current.yMin;
        }
